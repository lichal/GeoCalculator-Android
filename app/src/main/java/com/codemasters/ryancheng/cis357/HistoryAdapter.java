...
import com.codemasters.ryancheng.cis357.HistoryFragment.OnListFragmentInteractionListener;
import com.codemasters.ryancheng.cis357.dummy.HistoryContent.HistoryItem;
        ...
        HistoryAdapter.FooterViewHolder>
{
                                        ...
                                        int position)
    {
        ...
        String time = holder.mItem.timestamp.toString().substring(0, 10);

        time = time + " " + holder.mItem.timestamp.toString().substring(11, 16);
